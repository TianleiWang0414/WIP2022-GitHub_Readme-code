...
input csv file is required to have a col named readme to extract header info.
Run data_retrieval_readme beforehand
"""
# Regex expressions
...
if __name__ == "__main__":
    ...
    file_reader = pandas.read_csv(__file_name, encoding='UTF-8')
    ...
    concatResult.to_csv(__save_name, encoding='utf-8',index= False)
